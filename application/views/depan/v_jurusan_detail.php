        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="blog-tiltle_block">
                    <h4><a href="<?php echo site_url('informasi/'.$slug);?>"><?php echo $title;?></a></h4>
                    ...
                    <div class="blogpost-tabs">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="write-comment" role="tabpanel">
                                <form action="<?php echo site_url('jurusan/komentar');?>" method="post">
                                    <div class="row">
                                        <div class="col-6">
                ...
                <div class="blog-featured_post">
                  ...
                  <?php foreach ($populer->result() as $row) :?>
                    <div class="blog-featured-img_block">
                        ...
                        <h5><a href="<?php echo site_url('informasi/'.$row->jurusan_slug);?>"><?php echo limit_words($row->jurusan_judul,3).'...';?></a></h5>
