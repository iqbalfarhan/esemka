    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Post Jurusan</h3>
        </div>

		<form action="<?php echo base_url().'admin/jurusan/simpan_jurusan'?>" method="post" enctype="multipart/form-data">

        <!-- /.box-header -->
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              <input type="text" name="xjudul" class="form-control" placeholder="Judul Jurusan " required/>
            </div>
            <!-- /.col -->
            <div class="col-md-2">
        ...
        <div class="col-md-8">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Isi Artikel Jurusan</h3>
            </div>
            <div class="box-body">
